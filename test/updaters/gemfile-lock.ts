...
describe('Gemfile.lock', () => {
  describe('updateContent', () => {
    ...
    const testTable: [string, string, string, string, boolean, string][] = [
      ...
      ['foo', '0.3.0-alpha1', 'foo (0.2.0)', 'foo (0.3.0.alpha1)', true, 'prerelease'],
      ['foo', '0.3.0-alpha2', 'foo (0.3.0.alpha1)', 'foo (0.3.0.alpha2)', true, 'prerelease bump'],
      ['foo', '1.0.0-beta', 'foo (0.3.0.alpha2)', 'foo (1.0.0.beta)', true, 'beta'],
